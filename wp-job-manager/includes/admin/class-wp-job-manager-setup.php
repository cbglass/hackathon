				...
				<form action="<?php echo esc_url( add_query_arg( 'step', 3 ) ); ?>" method="post">
					<table class="wp-job-manager-shortcodes widefat">
						...
						<tbody>
							...
							<tr>
								<td><input type="checkbox" checked="checked" name="wp-job-manager-create-page[applied]" /></td>
								<td><input type="text" value="<?php echo esc_attr( _x( 'Applied', 'Default page title (wizard)', 'wp-job-manager' ) ); ?>" name="wp-job-manager-page-title[applied]" /></td>
								<td>
									<p><?php _e( 'This page allows user to see saved jobs.', 'wp-job-manager' ); ?></p>
								</td>
								<td><code>[applied]</code></td>
							</tr>
							<tr>
								<td><input type="checkbox" checked="checked" name="wp-job-manager-create-page[notes]" /></td>
								<td><input type="text" value="<?php echo esc_attr( _x( 'Notes', 'Default page title (wizard)', 'wp-job-manager' ) ); ?>" name="wp-job-manager-page-title[notes]" /></td>
								<td>
									<p><?php _e( 'This page allows user to see saved jobs.', 'wp-job-manager' ); ?></p>
								</td>
