			...
			array(
				...
				'job_pages' => array(
					...
					array(
						...
						array(
							'name' 		=> 'job_manager_applied_page_id',
							'std' 		=> '',
							'label' 	=> __( 'Job Applied Page', 'wp-job-manager' ),
							'desc'		=> __( 'Select the page where you have placed the [applied] shortcode. This lets the plugin know where the job listings page is located.', 'wp-job-manager' ),
							'type'      => 'page'
						),
						array(
							'name' 		=> 'job_manager_notes_page_id',
							'std' 		=> '',
							'label' 	=> __( 'Notes Page', 'wp-job-manager' ),
							'desc'		=> __( 'Select the page where you have placed the [notes] shortcode. This lets the plugin know where the job listings page is located.', 'wp-job-manager' ),
							'type'      => 'page'
						),
					)
				)
