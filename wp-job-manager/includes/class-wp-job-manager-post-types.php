...
class WP_Job_Manager_Post_Types {
	...
	public function __construct() {
		...
		add_action( 'job_manager_application_details_save', array( $this, 'application_details_save' ) );
	...
	public function application_details_save( $apply ) {
		get_job_manager_template( 'job-application-save.php', array( 'apply' => $apply ) );
	}
